...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull Button login, @NonNull EditText password, @NonNull TextView signUpPrompt) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, container, email, loading, login,
          password, signUpPrompt);
    }
